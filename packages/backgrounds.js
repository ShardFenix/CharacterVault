window.backgrounds=[
	{
		...
		name:"Criminal",
		description:[{content:"Skill Proficiencies: Deception, Stealth\nTool Proficiencies: Thieves' Tools\nEquipment: A crowbar, a set of dark common clothes including a hood, and a belt pouch containing 15 gp"}],
		...
		name:"Ex-Scholar",
		description:[{content:"Skill Proficiencies: Sleight of Hand, Stealth\nTool Proficiencies: Disguise kit, Thieves' tools\nEquipment: A small knife, a map of the city you grew up in, a pet mouse, a token to remember your parents by, a set of common clothes, and a belt pouch containing 10 gp"}],
		...
		name:"Noble",
		description:[{content:"Skill Proficiencies: History, Persuasion\nTool Proficiencies: One type of gaming set\nLanguages: One of your choice\nEquipment: A set of fine clothes, a signet ring, a scroll of pedigree, and a purse containing 25 gp"}],
		...
		name:"Awakened Cat",
		description:[{content:"Skill Proficiencies: Insight, Acrobatics\nLanguages: Any one\nEquipment: A reminder of your life before being awakened, a collar, a bowl with your old name, a bell attached to a length of ribbon that was your facorite toy."}],
		featureName:"Chatty Catty",
		featureDescription:"You can spot another awakened cat immediately, and know how to speak to them, how to win them over, and how to earn their trust. You can also communicate with non-awakened cats easily.",
		onPickup:function(char,scope){
			addProficiency(char,'Insight');
			addProficiency(char,'Acrobatics');
			addToInventory(char,findItem('Collar'));
			addToInventory(char,findItem("Bowl"));
			addToInventory(char,findItem('Pre-awakened memento'));
			addToInventory(char,findItem('Ribbon-Bell Cat Toy'));
			addPassive(char,{name:this.featureName,description:this.featureDescription});
			scope.choiceQueue.push(helper.learnLanguage);
		}
	}
